...
this is Poobesh. Jahnavi I think, when we search the query in the search box.. then the semantic map shoud be shown and highlight the entity in that map.. right...
but when I run that code, it display the semantic map and search box at a same time... If I search the query or even the word in the entity... no changes in the map...
can anyone run the code again...
